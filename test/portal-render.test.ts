...
/* ------------------------- handing a PR to somebody ------------------------ */

/**
 * The product-repo lane.
 *
 * A staff member's caller workflow lives in their own brain repo, so `@cto` on a pull request in
 * the product repo posts, renders as a chip, and wakes nobody. These three pin the only thing on
