...
| `brain_repo` | `playpip/technology` |
| `org` | `playpip` |
| `peers` | `playpip/marketing:marketing` |
| `products` | `playpip/pip-web:pip-web:0` |
| `needs_node` | `true` |
| `product_dir` | `pip-web` |
| `product_repo` | `playpip/pip-web` |
| `package_json` | `pip-web/package.json` |
...
└── pip-web/           a product repo, if declared
```
